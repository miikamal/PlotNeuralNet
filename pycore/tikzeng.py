...
def to_output(pathfile, off=0, to='(0,0,0)', width=8, height=8, name="temp", rotation=0, axis="x"):
    off = -off
    return r"""
    \begin{scope}[rotate around """+ axis +"""="""+ str(rotation) +"""]
    \\node[canvas is zy plane at x="""+ str(off) +"""] (""" + name + """) at """+ to +""" {\includegraphics[width="""+ str(width)+"cm"+""",height="""+ str(height)+"cm"+"""]{"""+ pathfile +"""}};
    \end{scope}
    """
